...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Music blog: interviews, selections, articles';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['interview', 'selection', 'review', 'news', 'story']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Musicians featured in the music blog';
    displayName: 'Artist';
    pluralName: 'artists';
    singularName: 'artist';
  };
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User comments with moderation (not localized)';
    displayName: 'Comment';
    pluralName: 'comments';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Afisha / cultural events';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    coordinates: Schema.Attribute.Component<'map.geo-point', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiFavoriteFavorite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User favorites (not localized)';
...
export interface ApiFeedbackFeedback extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Messages from the public feedback form (not localized)';
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Map points of interest';
...
export interface ApiRatingRating extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User ratings for routes (1\u20135, one per user per route, not localized)';
    displayName: 'Rating';
    pluralName: 'ratings';
    singularName: 'rating';
  };
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tourist routes across Buryatia';
    displayName: 'Route';
    pluralName: 'routes';
    singularName: 'route';
  };
  ...
  attributes: {
    activityType: Schema.Attribute.Enumeration<
      ['active', 'culture', 'nature', 'gastronomy', 'relax']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    coordinates: Schema.Attribute.Component<'map.geo-point', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'summer'>;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiSubscriberSubscriber extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Newsletter subscribers (not localized)';
